...
#//  file: -                                                 //
#//  -                                                       //
#//  Source: https://github.com/rui314/chibicc.git                                                //
...
#Not in debian buster : riscv64 linux/arm64 linux/ppc64le linux/s390x linux/386 linux/arm/v7 linux/arm/v6
